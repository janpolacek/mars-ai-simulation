...
surfaces, so gated terms may appear there only to *bar* material, never to place it.
...
sentences: the determination now records the identity mark as the only *identity* asset
