...
| Gate inputs     | `docs/timeline/001-project-announcement.md` (allowed angle, spoilers), `docs/SCENARIO.md` (locked canon, release controls), `docs/brand/BRAND_GUIDELINES.md`, `website/src/content.config.ts`, `website/src/pages/index.astro`, `website/scripts/sync-assets.mjs`, local build output `website/dist/` |
...
| Alt text                                            | PASS                            | `mediaAlt` matches the file actually used: a rust-red Mars disc crossed by low highlighted hills with a small Sun behind its upper-left edge; no text in the image. See section 7 for the missing Earth/Moon cue and the "on black" wording conflict with `docs/brand/BRAND_GUIDELINES.md`.                                                                                                                                                                                                                                                                                                                                                             |
...
2. **Identity-mark variant and release** — which variant should the 001 card carry
   ...
   of the mark released? `docs/brand/BRAND_GUIDELINES.md` requires a separate human
...
- `mediaAlt` omits the Earth/Moon cue that `docs/brand/BRAND_GUIDELINES.md` includes in
  ...
  that the crop hides.
- `docs/brand/BRAND_GUIDELINES.md` gives the mark's alt text as "…on black…", which does
...
- `docs/brand/BRAND_GUIDELINES.md` links its approved source as
