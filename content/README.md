...
`assets/articles/` is a review workspace, not a public asset directory. After
human media approval, copy a selected stable file to `assets/media/`; the
website build syncs that canonical public media directory to
`website/public/media/`. Do not put drafts, unapproved images, prompts, or
private scenario material in `website/public/`.
